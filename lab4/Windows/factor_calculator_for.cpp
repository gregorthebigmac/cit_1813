// Originally, I coded this on a Linux system, and thought I had accounted for anyone running it on Windows, but when I brought the
// Code over to VS 2017, it gave me a bunch of errors, so I had to modify the code (this file). If you check the git repo:
// https://github.com/gregorthebigmac/cit_1813	(inside the lab4 directory, obviously)
// you'll find the original version as I had it before migrating it to Windows, just in case this gives you any problems.
